...
public static class AuthEndpoints
{
    ...
    {
        app.MapPost("/api/auth/register", async (RegisterRequest request, IConfiguration configuration) =>
            {
                ...
                """;
                    ...
                    var emailCount =
                        Convert.ToInt32(await checkEmailCommand.ExecuteScalarAsync());
                ...
                """;
                    ...
                    var newUserId =
                        Convert.ToInt32(await insertUserCommand.ExecuteScalarAsync());
